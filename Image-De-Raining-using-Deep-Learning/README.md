...
This was an academic group project where we implemented De-Noising using CNN and GAN. I developed the CNN part and this folder contains to the code for the same. The GAN part was developed by my colleague, the details of which are mentioned in the draft paper. We also developed a UI for this project (details in the draft paper).
